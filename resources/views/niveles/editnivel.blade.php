          ...
          <div class="row">
            <div class="col-md-12">
              <div class="mu-page-breadcrumb-area">
                <h2>Detalle Nivel Programado <a href="{{URL::to('/nivel')}}" class="btn btn-primary">Niveles</a></h2>
                <ol class="breadcrumb">
                         ...
                         <div class="col-md-6 col-md-6">
                          ...
                          <div class="">
                            <figure class="mu-latest-course-img">
                              ...
                              <figcaption class="mu-latest-course-imgcaption">
                                <h5><b style="font-size: 20px;">Actualizar Nivel</b></h5>
                              </figcaption>
                            </figure>
                            <form action="{{route('nivel.update',$editarni->idnivel)}}" method="post" class="editar">
                              @csrf
                              @method('PUT')
                            <div class="mu-latest-course-single-content">
                              <input type="text" class="form-control" name="nombreni" pattern="[A-Za-z]+" title="Solo se permiten Letras(1 palabra)" value="{{$editarni->nombreni}}" required>
                            </div><br>
                            <div class="mu-latest-course-single-content">
                            <button type="submit" class="btn btn-primary" style="width: 200px;float: right;" title="Actualizar">Actualizar Nivel</button>
                            <a href="{{URL::to('/nivel')}}" class="btn btn-warning" style="width: 160px;float: center;"><i class="fas fa-arrow-alt-circle-left"></i> Cancelar</a>
                            </div><br>
                            <hr style="border:solid 2px;color:#466282;background-color: #466282">
                          </form>
                          </div>
                          ...
                          <div class="col-md-6 col-md-6">
                            ...
                            <div class="mu-latest-course-single">
                              <figure class="mu-latest-course-img">
                                <a href="#"><img src="/img/secundaria.jpg" alt="img"></a>
                              </figure>
                            </div>
                          ...
                          <div class="col-md-12 col-md-12">
                            <div class="row" >
                              ...
                              @php
                                  $niveles=DB::table('nivels')->orderby('idnivel','desc')->paginate(6);
                              @endphp
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="mu-latest-course-single">
                                  ...
                                  <figure class="mu-latest-course-img">
                                    <a   href="{{action('NivelController@edit',$nivel->idnivel)}}" title="Seleccionar" ><img alt="img" src="/img/img.jpg" height="180px;"></a>
                                    <figcaption class="mu-latest-course-imgcaption">
                                      <a   href="{{action('NivelController@edit',$nivel->idnivel)}}" title="Seleccionar" ><b>{{$nivel->nombreni}}</b></a>
                                      <span><b>2020</b></span>
                                    </figcaption>
                                  </figure>                               
                                  <div class="mu-latest-course-single-content">
                                    <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <a href="{{action('NivelController@edit',$nivel->idnivel)}}" style="float: left;width: 130px;" class="btn btn-primary" title="Seleccionar">Seleccionar <i class="fas fa-edit"></i></a>
